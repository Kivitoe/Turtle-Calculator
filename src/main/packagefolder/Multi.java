...
public class Multi {
	...
	private void initialize() {
		...
		frmTurtleCalculator.setIconImage(Toolkit.getDefaultToolkit().getImage(Multi.class.getResource("/com/sun/javafx/scene/control/skin/modena/HTMLEditor-Break.png")));
		...
		JButton btnAdd = new JButton("Multiply");
