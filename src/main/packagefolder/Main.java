...
/* This software is open source meaning that anyone can contribute.
 *        (c) 2016 - 2017 Kivitoe Inc.
 */
...
public class Main {
	...
	private void initialize() {
		...
		frmTurtleCalculator.setIconImage(Toolkit.getDefaultToolkit().getImage(Main.class.getResource("/com/sun/javafx/scene/control/skin/modena/HTMLEditor-Break.png")));
		...
		btnCancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frmTurtleCalculator.setVisible(false);
			}
		});
