...
public class Sub {
	...
	private void initialize() {
		...
		frmTurtleCalculator.setIconImage(Toolkit.getDefaultToolkit().getImage(Sub.class.getResource("/com/sun/javafx/scene/control/skin/modena/HTMLEditor-Break.png")));
		...
		JButton btnAdd = new JButton("Subtract");
